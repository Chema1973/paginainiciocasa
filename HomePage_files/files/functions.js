...
function set_image_size() {
    ...
    try {
        ...
        // --> Esto ajusta el tama�o, pero deja la imagen ajustada a la pantalla y se expande por un lado
...
/*  INI::Funciones Colocaci�n Iconos */
...
/**
 * Devuelve la posici�n de un icono que tiene que tener
 * Traduce coordenadas 2000*1000 a lo que mide realmente la imagen central
 * Se corrige si con el tama�o del icono se sale fuera
 * @param {any} oIco
 */
function get_ico_position(oIco) {
    ...
    // Correcci�n de la posici�n si est� fuera de la imagen central (pantalla)
...
/**
 * Devuelve la posici�n de un <area> que tiene que tener
 * Traduce coordenadas 2000*1000 a lo que mide realmente la imagen central
 * No se tiene en cuenta si sale de la pantalla. Las <areas> no aplican aumento, s�lo muestra su "border"
 * @param {any} oIco
 */
...
/**
 * Pinta la acci�n que se ejecutar� en el evento onclick de icono o del <area>
 * @param {any} oIco
 */
...
/*  FIN::Funciones Colocaci�n Iconos */
...
/**
 * Redimensiona el icono a la proporci�n definida (1=Tama�o Normal)
 * @param {any} sId
...
/*  INI:Funciones de Objetos - B�squeda */

/**
 * Esta funci�n es la principal de la b�squeda
 * al pasar el rat�n sobre el resultado
 * @param {any} sId
 */
...
/**
 * Esta funci�n es la principal de la b�squeda
 * al salir el rat�n del resultado
 * @param {any} sId
 */
function result_search_out(sId)
{
    // Quitar el 'resalto' a la l�neacomb
...
/**
 * Resalta la l�nea del resultado de la b�squeda
 * @param {any} sId
 */
...
/**
 * Quita el 'resalto' del resultado de la b�squeda
 * @param {any} sId
 */
...
/**
 * Realiza la b�squeda entre los iconos
 * @param {any} evt
 */
...
/*  FIN:Funciones de Objetos - B�squeda */
 ...
 * Crea el combo de Help (Listado) como m�nimo
 */
    ...
    try {
        ...
        if (dataCombos.length > 0) {
            ...
            for (var a = 0; a < dataCombos.length; a++) {
                ...
                // --> Hace que el texto de una opci�n, si es muy largo, se vea s�lo
                //     completo cuando se despliega y mantiene su tama�o normal
                ...
                // --> Ordenaci�n por el n� de orden
                dataCombos[a].combocoleccion.sort(orderByTextComboData);
                // --> Ordenaci�n por el texto

                $.each(dataCombos[a].combocoleccion, function (i, el) {
                    // �APAVISO
                    // Intentar recuperar la colecci�n filtrada directamente
        ...
        // los hacemos despu�s para a�adirlo en la colecci�n de datos de combos y act�e como todos
        ...
        // --> en jQuery se pueden a�adir varios atributos al mismo tiempo
...
/**
 * Funci�n estandar para cualquier combo de datos definido
...
function show_combo_data(sId) {
    try {
        ...
        if ($("#divComboBoxResult").children("select").attr("id") == "cmb" + sId) {
            ...
            // --> Quitamos el <select> del <div> "divComboBoxResult" y lo volvemos a a�adir al <body>
            $("#divComboBoxResult").append($("#cmb" + sId));
            // --> Al <div> "divComboBoxResult" le a�adimos el combo seleccionado
            $("#cmb" + sId).css("display", "block");
            // ---> Mostramos el combo

            // Tenemos que modificar el tama�o del div para help y el resto
            // Usamos LINQ sobre la colecci�n "dataCombos" y obtenemos el tama�o
...
/*
INI::Funciones Coordenadas del rat�n a escala 2000 * 1000
*/
...
/**
 * Calcula la la posici�n 2000 * 1000 en base a la posici�n del rat�n
 * @param {any} event
 */
...
/*
FIN::Funciones Coordenadas del rat�n a escala 2000 * 1000
*/
 ...
 * para los combos por su n�mero de orden
 * @param {any} a
 * @param {any} b
 */
 ...
 * may�sculas y luego las min�sculas
 * @param {any} a
 * @param {any} b
 */
...
function get_item_array(sId) {
    ...
    // se podr�a usar "filter" en lugar de "grep":
 ...
 * Tiene que llevar impl�cito que muestre el borde del icono/<area>
 * @param {any} sId
 */
